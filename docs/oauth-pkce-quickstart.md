...
Choose a runnable, dependency-pinned reference: [Node/Express](../node-express/README.md) for confidential JavaScript servers, [React](../react-public/README.md) for low-risk public browser clients, or [Django](../django-server/README.md) for confidential Python servers. Review the [authoritative contract](integration-contract.md), [error guidance](error-guidance.md), and [production checklist](production-checklist.md) before launch.
